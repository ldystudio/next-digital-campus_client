...
interface MessagingChatProfileProps {
    paginate?: (direction: number) => void
}

export default function MessagingChatProfile({ paginate }: MessagingChatProfileProps) {
    return (
                                ...
                                {messageInteractions.map((interaction) => (
                                    ...
                                    >
                                        <div className='flex'>
                                            ...
                                            <div className='flex justify-end text-small text-default-400'>
                                                {interaction.time}
                                            </div>
                                        </div>
